<div class="modal fade" id="crearModalProveedor" tabindex="-1" aria-labelledby="exampleModalCrearMedicamento" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCrearMedicamento">Lista Proveedores</h5>
