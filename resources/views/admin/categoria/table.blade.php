                        ...
                        <tr class="odd">
                            ...
                            <td class="text-end">
                                {{-- @can('editar directivos') --}}
                                    <a onclick="editar(`{{$categoria->id}}`,`{{$categoria->name}}`)"
                                ...
                                {{-- @endcan --}}
                                  <a onclick="eliminar(`{{$categoria->id}}`, `{{$categoria->name}}`)" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" title="" data-kt-action="product_remove" data-bs-original-title="Dar de baja">
